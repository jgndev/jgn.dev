...
const (
	...
	MetaDescription string = "jgn writes about cloud native development"
	...
	Author string = "Jeremy Novak"
	// Generator is the metadata property for the site in the html header for SEO
	Generator string = "jgn.dev"
	// ResumePdf is the URL to the PDF version of Jeremy's resume
	ResumePdf string = ""
	// ResumeDoc is the URL to the DOC version of Jeremy's resume
	ResumeDoc string = ""
)
